...
const POST_IT_SVG = `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g transform="rotate(2, 12, 12)">
    ...
    <path d="M3 3h18v18H5.5L3 18.5V3z" stroke="#202020" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  </g>
</svg>`;
...
export class CellPostIt {
    ...
    _openEditPanel() {
        ...
        const panel = jsPanel.create({
            ...
            callback: (panel) => {
                ...
                if (!annotation) {
                    setTimeout(() => this._switchToEdit(content, renderedEl), 50);
                }
            },
        });
    ...
    _addDeleteButton(panel) {
        ...
        deleteBtn.innerHTML = '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#202020" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6" fill="#f4a0a0"/></svg>';
        deleteBtn.style.cssText = 'background:none;border:none;cursor:pointer;padding:0 4px;display:flex;align-items:center;';
        ...
        const view = new EditorView({
            ...
            extensions: [
                ...
                EditorView.domEventHandlers({
                    blur: () => {
                        setTimeout(() => this._switchToRendered(contentEl, editorContainer, renderedEl), 100);
                    },
                    keydown: (e) => {
                        if (e.key === 'Escape') {
                            e.preventDefault();
